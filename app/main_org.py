...
character_processed = Counter("app_characters_processed_total", "Number of characters processed after filtering")
cache_hits = Counter("app_cache_hits_total", "Number of times the Redis cache was hit")
